...
namespace Week1App
{
    class Program
    {
        ...
        static void ReturnFullNameList(List<Member> members)
        {
            List<String> fullnameList = new List<string>();
            foreach (Member member in members)
            {
                fullnameList.Add(member.lastName + " " + member.firstName);
            }
        ...
        static void Main(string[] args)
        {
            ...
            PrintList(maleMembers);
            PrintOldest(members);
            Console.WriteLine("3.Return fullname list: ");
            ReturnFullNameList(members);
